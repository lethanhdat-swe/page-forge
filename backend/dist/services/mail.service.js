...
class MailService {
    ...
    static async sendVerificationEmail(to, token) {
        ...
        try {
            ...
            console.log(`[Mail Service]: Verification email successfully sent to ${to}`);
        }
        catch (error) {
            console.error(`[Mail Service Error]: Failed to send verification email to ${to}`, error);
            throw error;
        }
    }
    static async sendPasswordResetEmail(to, token) {
        ...
        try {
            await this.transporter.sendMail(mailOptions);
            console.log(`[Mail Service]: Password reset email successfully sent to ${to}`);
        }
        catch (error) {
            console.error(`[Mail Service Error]: Failed to send password reset email to ${to}`, error);
            throw error;
        }
    }
}
